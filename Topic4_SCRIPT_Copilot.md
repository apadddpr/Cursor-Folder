# TOPIC 4 · SCRIPT · GitHub Copilot
## Open when Joe says Copilot / GitHub · Return to Master after Section 2 or 3

**Your frame:** Give them flowers → where it thins out → where Cursor steps in → one quick example → discovery.

**Prep doc wedge:** snippet help → task completion · local suggestions → codebase context · point solution → integrated experience

**Lead differentiators here:** Large codebase · Platform · Time to value (standardization)
...
Listen. This is your wedge into large codebase performance.
...
> I would show task completion across the codebase, not single-file suggestions. Then workflow across write, review, and iterate. If standardization came up, how teams get on one standard without every developer inventing their own setup.
...
## MAP HIS WORDS → YOUR DIFFERENTIATOR (for you, not to read)

| If he says… | Lead with… |
|-------------|------------|
| Cross-file / Central / monolith | Large codebase · whole-repo context |
| Snippets fine, big tasks hard | Platform · task completion |
| Squads inconsistent | Time to value · one standard |
| Review bottleneck | Platform · review in the workflow |
...
## SOURCE NOTES (for you)

| Copilot strong at | Where teams feel the gap | Cursor edge |
|-------------------|--------------------------|-------------|
| Autocomplete in VS Code, GitHub integration | Weak on whole-repo / multi-file work | Full repo context, broader task completion |
| Enterprise maturity, low friction if GitHub-native | Large repos, cross-cutting changes | Integrated AI-native environment |
| | Standardizing across squads | One workspace, org guardrails |

See also: `Topic4_Doc_B_Copilot.md` · `Topic4_Prep_Doc_Cheat_Sheet.md`
