# Topic 4 · Pivot · Claude Code
## Open when Joe says Claude Code / Anthropic / terminal-first · Return to master at Q2 · calibrate

**Do NOT argue Claude is weak. Do NOT make it model vs model.**
...
Then go to your first question.
...
**JOT:** Who uses it = ____________________
...
**JOT:** Workflow = ____________________
...
**JOT:** Review gap = ____________________

---

### ▶ RETURN TO `Topic4_Master_Teleprompter.md` at Q2 · CALIBRATE

---

## SECTION 3 · IF HE PUSHES BACK

### BLOCK A · "Why not just Claude Code?"
...
One proof point only. Do not pile on.
